...
public class RbacSeedInitializer implements CommandLineRunner {
    ...
    private List<ApiRuleSeed> ruleSeeds() {
        return List.of(
                ...
                new ApiRuleSeed("PATCH", "/api/v1/admin/users/*/status", "ADMIN_USERS_SECURITY", "Update user status.", 10),
                new ApiRuleSeed("PATCH", "/api/v1/admin/users/*/lock", "ADMIN_USERS_SECURITY", "Lock users.", 10),
                new ApiRuleSeed("PATCH", "/api/v1/admin/users/*/unlock", "ADMIN_USERS_SECURITY", "Unlock users.", 10),
                new ApiRuleSeed("POST", "/api/v1/admin/users/*/revoke-tokens", "ADMIN_USERS_SECURITY", "Revoke user tokens.", 10),
                new ApiRuleSeed("POST", "/api/v1/admin/users/*/reset-password", "ADMIN_USERS_SECURITY", "Reset user password.", 10),
                new ApiRuleSeed("POST", "/api/v1/admin/users/*/reset-mfa", "ADMIN_USERS_SECURITY", "Reset user MFA.", 10),
