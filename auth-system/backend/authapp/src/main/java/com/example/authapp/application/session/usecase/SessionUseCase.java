package com.example.authapp.application.session.usecase;
...
public class SessionUseCase {
    ...
    private String resolveCurrentJti(HttpServletRequest request) {
        ...
        if (authorization != null && authorization.startsWith("Bearer ")) {
            return jwtTokenProvider.getJti(authorization.substring("Bearer ".length()));
        }
        return jwtTokenProvider.getJti(extractRefreshToken(request));
    }
