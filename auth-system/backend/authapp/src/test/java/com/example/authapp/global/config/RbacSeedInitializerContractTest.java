...
class RbacSeedInitializerContractTest {
    ...
    void seededRbacRulesCoverAdminFrontendApis() {
        List<ApiEndpoint> endpoints = List.of(
                ...
                new ApiEndpoint("GET", "/api/v1/admin/users/duplicate-check"),
                ...
                new ApiEndpoint("PATCH", "/api/v1/admin/users/alice/status"),
                new ApiEndpoint("PATCH", "/api/v1/admin/users/alice/lock"),
                new ApiEndpoint("PATCH", "/api/v1/admin/users/alice/unlock"),
                new ApiEndpoint("POST", "/api/v1/admin/users/alice/revoke-tokens"),
                new ApiEndpoint("POST", "/api/v1/admin/users/alice/reset-password"),
                new ApiEndpoint("POST", "/api/v1/admin/users/alice/reset-mfa"),
                new ApiEndpoint("POST", "/api/v1/admin/users/alice/roles"),
                new ApiEndpoint("DELETE", "/api/v1/admin/users/alice/roles/1"),
                new ApiEndpoint("GET", "/api/v1/admin/hr-users"),
                new ApiEndpoint("GET", "/api/v1/admin/hr-users/candidates"),
                new ApiEndpoint("GET", "/api/v1/admin/hr-users/duplicate-check"),
                new ApiEndpoint("POST", "/api/v1/admin/hr-users"),
                new ApiEndpoint("PATCH", "/api/v1/admin/hr-users/1"),
                new ApiEndpoint("DELETE", "/api/v1/admin/hr-users/1"),
