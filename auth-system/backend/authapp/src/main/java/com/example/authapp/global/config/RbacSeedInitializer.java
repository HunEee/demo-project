...
public class RbacSeedInitializer implements CommandLineRunner {
    ...
    private List<PermissionSeed> permissionSeeds() {
        return List.of(
                ...
                new PermissionSeed("ADMIN_DEPARTMENTS_READ", "Admin departments read", "ORGANIZATION", "Read departments.", false),
                new PermissionSeed("ADMIN_DEPARTMENTS_WRITE", "Admin departments write", "ORGANIZATION", "Create, update, disable, or assign departments.", true),
    ...
    private List<ApiRuleSeed> ruleSeeds() {
        return List.of(
                ...
                new ApiRuleSeed("GET", "/api/v1/admin/departments/**", "ADMIN_DEPARTMENTS_READ", "Read departments.", 10),
                new ApiRuleSeed("POST", "/api/v1/admin/departments/**", "ADMIN_DEPARTMENTS_WRITE", "Write departments.", 10),
                new ApiRuleSeed("PATCH", "/api/v1/admin/departments/**", "ADMIN_DEPARTMENTS_WRITE", "Write departments.", 10),
                new ApiRuleSeed("DELETE", "/api/v1/admin/departments/**", "ADMIN_DEPARTMENTS_WRITE", "Write departments.", 10),
